...
print("Surface Water Discharge:", final_grid.at_node.get('surface_water__discharge'))
print("Drainage Area:", final_grid.at_node.get('drainage_area'))
print("Water Unit Flux In:", final_grid.at_node.get('water__unit_flux_in'))
