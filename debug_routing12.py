...
# The issue seems to be in `_apply_nodata_mask_to_all_fields` which modifies fields.
# Wait, does it delete fields? No, it just modifies them.
# What happens if we do this:
print("Before any changes, discharge_field is None:", grid.at_node.get('surface_water__discharge', None) is None)
